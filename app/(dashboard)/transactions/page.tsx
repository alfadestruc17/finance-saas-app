...
import {
    ImportCard,
    type ImportResult,
} from "@/features/transactions/components/import-card";
...
const INITIAL_IMPORT_RESULTS: { data: string[][] } = {
    data: [],
};
...
const TransactionsPage = () => {
    ...
    const onSubmitImport = async (values: ImportResult[]) => {
        ...
        createTransactions.mutate(
            data as unknown as (typeof transactionsSchema.$inferInsert)[],
            {
                onSuccess: () => {
                    onCancelImport();
                },
